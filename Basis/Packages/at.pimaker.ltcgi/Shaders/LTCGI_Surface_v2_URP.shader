Shader "LTCGI/Surface (APIv2) URP"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _ _METALLICSPECGLOSSMAP
            ...
            half4 LitPassFragment(Varyings input, FRONT_FACE_TYPE frontFace : FRONT_FACE_SEMANTIC) : SV_Target
            {
                ...
                input.normalWS *= IS_FRONT_VFACE(frontFace, 1.0, -1.0);
                ...
                smooth *= _Glossiness;
                    ...
                    // URP/Lit packing: R = metallic, A = smoothness scaled by the _Glossiness slider
                    half4 mg = SAMPLE_TEXTURE2D(_MetallicGlossMap, sampler_MetallicGlossMap, input.uv);
                    metallic = mg.r;
                    smooth   = mg.a * _Glossiness;
                #endif
